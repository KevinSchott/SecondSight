...
{
	public class NewDBPage9 : InteriorWizardPage
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(NewDBPage9));
			...
			// m_titleLabel
			// 
			this.m_titleLabel.Text = "Create New Database - Confirm Database Information";
			// 
			// m_subtitleLabel
			// 
			...
			"se.  If not, click \'Back\' and correct the information.";
			// 
			// NewDBPage9
			// 
